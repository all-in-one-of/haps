...
if ( "$arg1" != "" ) then
    ...
    # opproperty -f -F "Extra Image Planes"   $arg1 appleseed default_mages_extra
    ...
    opproperty -f -F "Path Tracing"                $arg1 appleseed default_rendering_pr
    opproperty -f -F "SPPM"                        $arg1 appleseed default_rendering_sppm
    ...
    opproperty -f -F "Driver" $arg1 appleseed aps_tmpsharedstorage
    opproperty -f -F "Driver" $arg1 appleseed aps_tmplocalstorage
